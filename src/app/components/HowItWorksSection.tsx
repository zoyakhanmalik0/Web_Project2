    ...
    <section className="relative min-h-screen py-20 overflow-hidden">
      ...
      <div className="container relative mx-auto !z-20">
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          ...
          <div className="lg:text-xl text-gray-400 text-justify lg:pt-16">
            <p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div data-aos="fade-up" className="group relative overflow-hidden bg-blackfade2 rounded-[32px] p-8 min-h-[400px] hover:bg-[#151515] transition-colors duration-300">
            <div className="flex justify-between items-start mb-8">
              ...
              <div className="w-10 h-10 rounded-full border border-default flex items-center justify-center group-hover:bg-default transition-all duration-500 group-hover:rotate-45">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-default group-hover:text-black transition-colors">
                  <path d="M7 7h10v10" />
                  <path d="M7 17 17 7" />
                </svg>
              </div>
            ...
            <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
              ...
              <div className="relative group">
                <div className="absolute -right-11 -bottom-10 w-40 h-40 bg-default duration-1000 rounded-2xl flex items-center justify-center overflow-hidden group-hover:bg-black">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" stroke="currentColor" strokeWidth="2" className="w-14 h-14 text-black transition-colors duration-700 ease-out group-hover:text-white">
          ...
          <div data-aos="fade-up" className="group relative overflow-hidden bg-blackfade2 rounded-[32px] p-8 min-h-[400px] hover:bg-[#151515] transition-colors duration-300">
            <div className="flex justify-between items-start mb-8">
              ...
              <div className="w-10 h-10 rounded-full border border-default flex items-center justify-center group-hover:bg-default transition-all duration-500 group-hover:rotate-45">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-default group-hover:text-black transition-colors">
                  <path d="M7 7h10v10" />
                  <path d="M7 17 17 7" />
                </svg>
              </div>
        ...
        {/* Rotating Sphere Half Inside Left */}
        <div className="absolute bottom-20 -left-1/2 -z-10">
          <img
