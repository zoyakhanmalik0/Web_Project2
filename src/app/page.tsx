...
const SERVICES = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-activity w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-palette w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><circle cx="13.5" cy="6.5" r=".5"></circle><circle cx="17.5" cy="10.5" r=".5"></circle><circle cx="8.5" cy="7.5" r=".5"></circle><circle cx="6.5" cy="12.5" r=".5"></circle><path d="M12 22a10 10 0 1 1 10-10c0 5.523-4.477 10-10 10zm0 0a4 4 0 0 1-4-4c0-2.21 1.79-4 4-4s4 1.79 4 4a4 4 0 0 1-4 4z"></path></svg>
    ),
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-share-2 w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><path d="M8.59 13.51l6.83 3.98"></path><path d="M15.41 6.51l-6.82 3.98"></path></svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-bar-chart-2 w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><line x1="18" x2="18" y1="20" y2="10"></line><line x1="12" x2="12" y1="20" y2="4"></line><line x1="6" x2="6" y1="20" y2="14"></line></svg>
    ),
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-code w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>
    ),
  },
  {
    name: 'Cyber Security',
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shield w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
    ),
  },
  {
    name: 'E-Commerce',
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-image w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg>
    ),
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-film w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"></rect><line x1="7" y1="2" x2="7" y2="22"></line><line x1="17" y1="2" x2="17" y2="22"></line><line x1="2" y1="12" x2="22" y2="12"></line><line x1="2" y1="7" x2="7" y2="7"></line><line x1="2" y1="17" x2="7" y2="17"></line><line x1="17" y1="17" x2="22" y2="17"></line><line x1="17" y1="7" x2="22" y2="7"></line></svg>
    ),
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-credit-card w-8 h-8 sm:w-10 sm:h-10 text-default stroke-[1.5]"><rect x="2" y="5" width="20" height="14" rx="2" ry="2"></rect><line x1="2" y1="10" x2="22" y2="10"></line></svg>
    ),
  },
];
  ...
  return (
    <>
      <Head>
        ...
        <title>Acciobyte – Web, App, Design &amp; Pen Testing Services</title>
      ...
      <div style={{position:'fixed',top:0,left:0,width:'15px',height:'15px',backgroundColor:'#BFF747',borderRadius:'50%',pointerEvents:'none',transform:'translate(-50%, -50%)',zIndex:9999}} className="hidden lg2:block"></div>
        ...
        <div className="container relative mx-auto z-20 px-4 lg:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            <div className="lg:sticky lg:top-24 h-fit self-start text-center lg:text-start">
              <div className="w-full text-default text-base sm:text-18 font-bold flex items-center justify-center lg:justify-start gap-4 my-6 sm:my-9">
                <img src="/media/asterisk_default.4355d764.png" alt="Acciobyte Asteric Image" className="w-4 h-4 sm:w-5 sm:h-5" />
                <h4>ABOUT AGENCY</h4>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white mb-4">Crafting <span className="text-default font-bold">unique digital</span></h2>
            ...
            <div className="relative z-10 space-y-6 sm:space-y-8">
              ...
              <div className="relative flex gap-4 sm:gap-6 group cursor-pointer">
                <div className="hidden lg:block absolute -left-[40px] top-1/2 w-8 h-8 rounded-full -translate-y-1/2">
                  <img src="/media/dot.5c102e3c.svg" alt="Acciobyte Dot Service" />
                </div>
                <div className="flex flex-col gap-4 sm:gap-5">
                  <img src="/media/mission.25c4c757.svg" alt="Acciobyte Service Icon" className="w-16 h-16 sm:w-20 sm:h-20 bg-default rounded-lg p-3" />
                  <h3 className="text-white text-lg sm:text-xl lg:text-3xl font-bold mb-2 group-hover:text-default transition-colors">Your Success, Our Mission</h3>
              ...
              <div className="relative flex gap-4 sm:gap-6 group cursor-pointer">
                ...
                <div className="flex flex-col gap-4 sm:gap-5">
                  <img src="/media/creators.da5dacdb.svg" alt="Acciobyte Service Icon" className="w-16 h-16 sm:w-20 sm:h-20 bg-default rounded-lg p-3" />
                  <h3 className="text-white text-lg sm:text-xl lg:text-3xl font-bold mb-2 group-hover:text-default transition-colors">Creators Of Digital Excellence</h3>
              ...
              <div className="relative flex gap-4 sm:gap-6 group cursor-pointer">
                ...
                <div className="flex flex-col gap-4 sm:gap-5">
                  <img src="/media/innovation.257d9eb9.svg" alt="Acciobyte Service Icon" className="w-16 h-16 sm:w-20 sm:h-20 bg-default rounded-lg p-3" />
                  <h3 className="text-white text-lg sm:text-xl lg:text-3xl font-bold mb-2 group-hover:text-default transition-colors">Innovating the digital landscape</h3>
              ...
              <div className="relative flex gap-4 sm:gap-6 group cursor-pointer">
                ...
                <div className="flex flex-col gap-4 sm:gap-5">
                  <img src="/media/brands.6176527f.svg" alt="Acciobyte Service Icon" className="w-16 h-16 sm:w-20 sm:h-20 bg-default rounded-lg p-3" />
                  <h3 className="text-white text-lg sm:text-xl lg:text-3xl font-bold mb-2 group-hover:text-default transition-colors">Helping Brands Thrive Online</h3>
          ...
          <div className="absolute bottom-20 -left-32 z-0 hidden lg:block">
            <img src="/media/sphere.4b56a70e.png" alt="Acciobyte Sphere Image" className="w-96 h-96 animate-spin-slow" />
          </div>
        </div>
      </section>
        ...
        <div className="container relative mx-auto z-20 px-4 lg:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            <div className="h-fit self-start text-center lg:text-start">
              <div className="w-full text-default text-base sm:text-18 font-bold flex items-center justify-center lg:justify-start gap-4 my-6 sm:my-9">
                <img src="/media/asterisk_default.4355d764.png" alt="Astrivix Asteric Image" className="w-4 h-4 sm:w-5 sm:h-5" />
                <h4>OUR SERVICES</h4>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white mb-4">Our <span className="text-default font-bold">digital services</span></h2>
          ...
          <div className="container mx-auto py-12 sm:py-16 lg:py-20">
            ...
            <div className="text-center mt-12 sm:mt-16 lg:mt-20">
                              <p className="text-white text-lg sm:text-xl">Let&apos;s make something great work together. <Link className="text-default hover:underline underline-offset-4" href="/pricing-plan">Get Free Quote</Link></p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center mb-7 gap-8 lg:gap-0">
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-2">
                <img src="/media/asterisk_default.4355d764.png" alt="Astrivix Asteric" className="w-4 h-4 sm:w-5 sm:h-5" />
                <span className="text-white uppercase tracking-wider font-semibold text-sm sm:text-base">WHY CHOOSE</span>
              </div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl !leading-normal text-white font-light">Expertise for <span className="text-default font-semibold">your digital</span><br />growth journey</h2>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="lg:sticky lg:top-20 space-y-8">
              <div className="image-container group relative w-full h-full rounded-2xl sm:rounded-3xl overflow-hidden">
                <img src="/media/whyus.fe999c9a.png" alt="Business meeting" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
          <div className="absolute bottom-20 -right-32 z-0 hidden lg:block">
            <img src="/media/hex.eced7c60.png" alt="Astrivix Sphere Image" className="w-80 h-80 animate-spin-grow" />
          </div>
        </div>
      </section>
          ...
          <div className="relative mx-auto z-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="h-fit self-start text-center lg:text-start">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white mb-4">Innovative <span className="text-default font-bold">features</span></h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 mt-8 sm:mt-10 lg:mt-0">
              <div className="bg-blackfade2/40 backdrop-blur-lg p-6 sm:p-10 rounded-[24px] sm:rounded-[32px] overflow-hidden group hover:bg-[#151515] transition-colors duration-300 col-span-1 lg:col-span-3">
                <div className="relative overflow-hidden rounded-[24px] sm:rounded-[32px]">
                  <img src="/media/cbs.e73564e5.jpg" alt="Custom Branding Solutions" width={10000} height={10000} className="w-full h-60 sm:h-80 object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
              ...
              <div className="bg-blackfade2/40 backdrop-blur-lg p-6 sm:p-10 rounded-[24px] sm:rounded-[32px] overflow-hidden group hover:bg-[#151515] transition-colors duration-300 col-span-1 lg:col-span-2">
                <div className="relative overflow-hidden rounded-[24px] sm:rounded-[32px]">
                  <img src="/media/dddm.b39136e5.jpg" alt="Data-Driven Digital Marketing" width={10000} height={10000} className="w-full h-60 sm:h-80 object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                <div className="p-6 sm:p-8">
...
function RotatingText({ texts }: { texts: string[] }) {
  ...
  return (
    <span
      key={index}
      className={`text-default font-bold w-full h-full p-2 sm:p-3 break-words whitespace-normal text-2xl sm:text-3xl md:text-4xl lg:text-[5.5rem] transition-all duration-500 ease-in-out inline-block
