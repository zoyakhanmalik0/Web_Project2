...
export default function About() {
  return (
    <div className="!w-full bg-cover bg-center bg-black text-white" style={{ backgroundImage: 'url(/media/bg.0f5970d1.png)' }}>
      {/* Hero Section */}
        ...
        <div className="container mx-auto">
          <div className="relative mx-auto !z-20">
            ...
            <div className="grid md:grid-cols-5 gap-6 mt-10 lg:mt-0">
              <div className="bg-blackfade2/40 backdrop-blur-lg p-10 rounded-[32px] overflow-hidden group hover:bg-[#151515] transition-colors duration-300 col-span-5 lg:col-span-3">
              ...
              <div className="bg-blackfade2/40 backdrop-blur-lg p-10 rounded-[32px] overflow-hidden group hover:bg-[#151515] transition-colors duration-300 col-span-5 lg:col-span-2">
                <div className="relative overflow-hidden rounded-[32px]">
            ...
            <div className="overflow-hidden cursor-grab active:cursor-grabbing">
              <div className="flex gap-6 px-6">
                {[
                  ...
                  <div key={idx} className="flex-shrink-0 bg-[#1a1a1a] rounded-2xl px-8 py-6 flex items-center justify-center min-w-[200px]">
                    <Image src={item.src} alt={item.alt} width={100} height={30} className="w-auto h-8" draggable={false} />
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="container relative mx-auto px-4 !z-20">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="relative">
            <div className="relative flex flex-col gap-6 lg:py-24 group cursor-pointer">
              <div className="flex flex-col gap-5">
                <p className="text-white text-center lg:text-justify leading-relaxed lg:text-lg">Our digital services empower brands with innovative strategies and solutions for sustainable growth and engagement.Our digital services empower brands with innovative strategies and solutions for sustainable growth and engagement.</p>
              </div>
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="w-full h-96 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
              {[1, 2, 3, 4].map((idx) => (
                <div key={idx} className="relative group rounded-[32px] overflow-hidden cursor-pointer">
                  <div className="relative">
                    <Image src="/media/team.53181386.jpg" alt="Team Member" width={400} height={400} className="object-cover" />
                    ...
                    <div className="absolute bottom-10 left-0 right-0 p-6 transform translate-y-16 opacity-0 transition-all duration-[1200ms] ease-out group-hover:translate-y-0 group-hover:opacity-100">
                      <h3 className="text-white text-2xl font-semibold mb-2">{['Sarah Mitchell', 'Brooklyn Simmons', 'Emily Davis', 'Jessica Taylor'][idx-1]}</h3>
                      <p className="text-gray-300 text-sm">{['Senior Project Manager', 'Marketing Director', 'Product Manager', 'Communications Specialist'][idx-1]}</p>
                      <div className="hidden group-hover:flex gap-3 mt-4 transform translate-y-8 opacity-0 transition-all duration-[1000ms] ease-out group-hover:translate-y-0 group-hover:opacity-100">
                        {/* Social icons */}
                        <a href="#" className="w-10 h-10 rounded-full border-2 border-[#86c232] flex items-center justify-center group hover:bg-[#86c232] transition-colors duration-300">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-12">
              {[
                ...
                <div key={idx} className="relative p-8 rounded-3xl bg-transparent border border-gray-800 overflow-hidden cursor-pointer group">
                  <div className="absolute inset-0 transition-transform duration-700 ease-in-out bg-[length:130%_100%] bg-no-repeat" style={{ backgroundImage: 'linear-gradient(to right, #1a1a1a 0%, #1a1a1a 40%, rgba(26,26,26,0.9) 55%, rgba(26,26,26,0.7) 60%, rgba(26,26,26,0.5) 65%, rgba(26,26,26,0.3) 70%, rgba(26,26,26,0.1) 75%, transparent 90%)' }}></div>
                  <div className="relative z-10">
                    <h3 className="text-white text-xl lg:text-2xl font-semibold mb-4">{item.title}</h3>
            ...
            <div className="lg:sticky lg:top-20 space-y-8">
              <div className="image-container group relative w-full h-full rounded-3xl overflow-hidden">
                <Image src="/media/whyus.fe999c9a.png" alt="Business meeting" width={320} height={320} className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        <div className="absolute bottom-20 -right-32 z-0">
          <Image src="/media/hex.eced7c60.png" alt="Hex" width={320} height={320} className="w-80 h-80 animate-spin-grow" />
        </div>
      </section>
          ...
          <div className="relative mx-auto !z-20">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="relative">
                <div className="relative flex flex-col gap-6 lg:py-24 group cursor-pointer">
                  <div className="flex flex-col gap-5">
                    <p className="text-white text-center lg:text-justify leading-relaxed lg:text-lg">Discover how our clients have achieved success through our innovative solutions and dedicated support.</p>
                  </div>
                  <a className="mt-4 flex !justify-center lg:!justify-start gap-4 group" href="#">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              <div className="md:col-span-4 bg-black/60 backdrop-blur-sm rounded-3xl p-8 flex flex-col items-center justify-between">
                <div className="text-center">
                  <div className="text-7xl font-bold mb-2"><div>0.0</div></div>
                  ...
                  <h3 className="text-2xl font-semibold text-center">Customer experiences that speak for themselves</h3>
                </div>
                <div className="flex -space-x-2 mt-8">
                  {[1,2,3,4,5].map((_,i) => (
                    <div key={i} className="relative w-10 h-10 rounded-full overflow-hidden border-2 border-black">
                      <Image src="/media/dummy_user.3212c1e3.png" alt={`Customer ${i+1}`} width={40} height={40} className="object-cover" />
                    </div>
                  ))}
                </div>
              </div>
              <div className="md:col-span-8 relative">
                <div className="h-full flex flex-col justify-between">
                  <div className="mb-8">
                    ...
                    <p className="text-xl md:text-2xl mb-8 leading-relaxed">Super impressed with their mobile app development service. The team listened carefully to our needs and delivered an app that exceeded expectations. A little delay in testing phase but they managed it professionally. Highly recommended!</p>
                  </div>
                  <div className="flex items-center">
                    <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4">
                      <Image src="/media/dummy_user.3212c1e3.png" alt="Olivia Reed" width={64} height={64} className="object-cover" />
                    </div>
                    <div>
                    ...
                    <div className="ml-auto flex space-x-2">
                      <button className="w-12 h-12 rounded-full bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" aria-label="Previous testimonial">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-left w-5 h-5"><path d="m12 19-7-7 7-7"></path><path d="M19 12H5"></path></svg>
                      </button>
                      <button className="w-12 h-12 rounded-full bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" aria-label="Next testimonial">
