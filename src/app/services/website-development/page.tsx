...
import MovingService from "../../components/MovingServices";
  ...
  const processSteps = [
    {
      ...
      description: "We understand your business needs, target audience, and goals to create a development roadmap.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8.3 10a.7.7 0 0 1-.626-1.079L11.4 3a.7.7 0 0 1 1.198-.043L16.3 8.9a.7.7 0 0 1-.572 1.1Z"></path><rect x="3" y="14" width="7" height="7" rx="1"></rect><circle cx="17.5" cy="17.5" r="3.5"></circle></svg>,
      image: "/media/step1.e543bf87.jpg",
      order: "md:order-1"
    },
    {
      step: "02",
      title: "Design & Development",
      description: "Our designers create a visually appealing UI, while developers build a functional, high-performance website.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"></path><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"></path><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"></path></svg>,
      image: "/media/step2.12f8307f.jpg",
      order: "md:order-2"
    },
    {
      step: "03",
      title: "Testing & Deployment",
      description: "We conduct thorough testing to ensure security, responsiveness, and speed before launching the website.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5V19A9 3 0 0 0 21 19V5"></path><path d="M3 12A9 3 0 0 0 21 12"></path></svg>,
      image: "/media/step3.ac9c3e07.jpg",
      order: "md:order-1"
    }
  ];
    ...
    <main className="!w-full bg-cover bg-center bg-black text-white pb-10" style={{ backgroundImage: 'url(/media/bg.0f5970d1.png)' }}>
      <div className="w-full h-full flex items-center justify-center py-48 relative bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/media/Inner_bg.23beb686.jpg)' }}>
        <div className="flex flex-col justify-center items-center xl:max-w-6xl gap-8 font-semibold text-white">
          <h1 className="text-4xl text-center xl:text-7xl">Website <span className="text-default">Development</span></h1>
          <nav aria-label="Breadcrumb">
            <ol className="container flex items-center space-x-2 text-18 font-semibold text-white py-1.5 px-2">
              ...
              <li className="flex items-center"><span className="mx-2">*</span><span className="text-default" aria-current="page">Website development</span></li>
            </ol>
          </nav>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr,400px] gap-12 lg:gap-20">
          ...
          <div className="space-y-12">
            <div className="rounded-[32px] overflow-hidden">
              <img 
                src="/media/sec1.b627f3b3.jpg" 
                alt="Business people discussing website development" 
                width={800} 
                height={400} 
              ...
              <div className="rounded-[32px] overflow-hidden">
                <div className="grid md:grid-cols-1 gap-6">
                  ...
                  {processSteps.map((step, index) => (
                    <div key={index} className={`flex flex-col md:flex-row md:items-center gap-6 ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                      <div className="bg-blackfade2 rounded-[32px] p-10 flex flex-col flex-1">
                        <div className="flex items-start justify-between mb-8">
                          <span className="w-16 h-16 text-default">{step.icon}</span>
                          <span className="text-24 text-center text-white flex flex-col">STEP <span className="text-default font-bold">{step.step}</span></span>
                        </div>
                        <h3 className="text-white text-2xl font-bold mb-4">{step.title}</h3>
                        <p className="leading-relaxed">{step.description}</p>
                      </div>
                      
                      <div className="relative aspect-[4/3] rounded-[32px] overflow-hidden flex-1">
                        <img 
                          src={step.image} 
                          alt={step.title} 
